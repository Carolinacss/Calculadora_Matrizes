 ...
 * ------------------------------------------------------------ */
void somarMatrizes(Matriz a, Matriz b) {
    Matriz resultado;
    int i, j;
 ...
 * ------------------------------------------------------------ */
void subtrairMatrizes(Matriz a, Matriz b) {
    Matriz resultado;
    int i, j;
 ...
 * ------------------------------------------------------------ */
void multiplicarMatrizes(Matriz a, Matriz b) {
    Matriz resultado;
    int i, j, k;
 ...
 * ------------------------------------------------------------ */
void multiplicarPorEscalar(Matriz a) {
    Matriz resultado;
    double escalar;
    int i, j;
    ...
    do {
        ...
        switch (opcao) {
            ...
            default:
                ...
                printf("\nOpcao invalida! Escolha um numero entre 0 e 9.\n");
                break;
        }
